...
{
    RAY_BB = 1,
    RAY_POLY = 3,           // mapmodel mesh
    RAY_ALPHAPOLY = 7,      // mapmodel mesh with alpha masked textures
    RAY_ENTS = 9,
    RAY_CLIPMAT = 16,
    RAY_SKIPFIRST = 32,     // ignore cube at origin
    RAY_EDITMAT = 64,       // hit cubes with any material
    RAY_SHADOW = 128,
    RAY_PASS = 256,
    RAY_SKIPSKY = 512,
    RAY_SKYTEX = 1024,
    RAY_SELECT = 2048,      // make it easier to select while inside solid cubes / materials
};
...
extern void g3d_setcursor(int x, int y);
